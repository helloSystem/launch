...
public:
    explicit ApplicationSelectionDialog(QString *fileOrProtocol, QString *mimeType, QStringList *appCandidates, QString &selectedApplication, QWidget *parent = nullptr);
